...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProjectDetails.priority'
        db.delete_column('projects_projectdetails', 'priority')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ProjectDetails.priority'
        raise RuntimeError("Cannot reverse this migration. 'ProjectDetails.priority' and its values cannot be restored.")
