...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('projects_project', ['label'])

        # Adding unique constraint on 'Project', fields ['agency', 'label']
        db.create_unique('projects_project', ['agency_id', 'label'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['agency', 'label']
        db.delete_unique('projects_project', ['agency_id', 'label'])

        # Adding unique constraint on 'Project', fields ['label']
        db.create_unique('projects_project', ['label'])
