...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field goals on 'ProjectInfo'
        db.create_table('projects_projectinfo_goals', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('projectinfo', models.ForeignKey(orm['projects.projectinfo'], null=False)),
            ('goal', models.ForeignKey(orm['projects.goal'], null=False))
        ))
        db.create_unique('projects_projectinfo_goals', ['projectinfo_id', 'goal_id'])


    def backwards(self, orm):
        # Removing M2M table for field goals on 'ProjectInfo'
        db.delete_table('projects_projectinfo_goals')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'datetime_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        ...
        'projects.projectinfo': {
            ...
            'methodology_other': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
