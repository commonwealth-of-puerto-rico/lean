...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field other_agencies on 'ProjectOpportunities'
        db.create_table('projects_projectopportunities_other_agencies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('projectopportunities', models.ForeignKey(orm['projects.projectopportunities'], null=False)),
            ('agency', models.ForeignKey(orm['agencies.agency'], null=False))
        ))
        db.create_unique('projects_projectopportunities_other_agencies', ['projectopportunities_id', 'agency_id'])


    def backwards(self, orm):
        # Removing M2M table for field other_agencies on 'ProjectOpportunities'
        db.delete_table('projects_projectopportunities_other_agencies')
