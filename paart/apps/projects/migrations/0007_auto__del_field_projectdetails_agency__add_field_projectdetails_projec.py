...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ProjectDetails.agency'
        raise RuntimeError("Cannot reverse this migration. 'ProjectDetails.agency' and its values cannot be restored.")
