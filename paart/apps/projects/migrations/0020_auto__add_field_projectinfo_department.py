...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectInfo.department'
        db.add_column('projects_projectinfo', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Department']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectInfo.department'
        db.delete_column('projects_projectinfo', 'department_id')
