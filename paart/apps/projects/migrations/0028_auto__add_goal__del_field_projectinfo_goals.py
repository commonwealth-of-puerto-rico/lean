...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Goal'
        db.create_table('projects_goal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('projects', ['Goal'])

        # Deleting field 'ProjectInfo.goals'
        db.delete_column('projects_projectinfo', 'goals')


    def backwards(self, orm):
        # Deleting model 'Goal'
        db.delete_table('projects_goal')


        # User chose to not deal with backwards NULL issues for 'ProjectInfo.goals'
        raise RuntimeError("Cannot reverse this migration. 'ProjectInfo.goals' and its values cannot be restored.")
