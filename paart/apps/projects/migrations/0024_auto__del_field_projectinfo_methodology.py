...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('projects_projectinfo', 'methodology')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectInfo.methodology'
        raise RuntimeError("Cannot reverse this migration. 'ProjectInfo.methodology' and its values cannot be restored.")
