...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectDetails.topic'
        db.delete_column('projects_projectdetails', 'topic_id')

        # Deleting field 'ProjectDetails.topic_other'
        db.delete_column('projects_projectdetails', 'topic_other')

        # Deleting field 'ProjectDetails.benefit'
        db.delete_column('projects_projectdetails', 'benefit_id')

        # Deleting field 'ProjectDetails.benefit_other'
        db.delete_column('projects_projectdetails', 'benefit_other')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectDetails.topic'
        raise RuntimeError("Cannot reverse this migration. 'ProjectDetails.topic' and its values cannot be restored.")
        # Adding field 'ProjectDetails.topic_other'
        db.add_column('projects_projectdetails', 'topic_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ProjectDetails.benefit'
        raise RuntimeError("Cannot reverse this migration. 'ProjectDetails.benefit' and its values cannot be restored.")
        # Adding field 'ProjectDetails.benefit_other'
        db.add_column('projects_projectdetails', 'benefit_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)
