...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.default'
        db.add_column('projects_state', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.default'
        db.delete_column('projects_state', 'default')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'datetime_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 0, 0)'}),
