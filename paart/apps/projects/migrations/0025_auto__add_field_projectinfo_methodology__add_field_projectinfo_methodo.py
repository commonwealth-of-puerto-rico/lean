...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectInfo.methodology'
        db.add_column('projects_projectinfo', 'methodology',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Methodology']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'ProjectInfo.methodology'
        db.delete_column('projects_projectinfo', 'methodology_id')
