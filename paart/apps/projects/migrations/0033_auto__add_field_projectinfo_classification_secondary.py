...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectInfo.classification_secondary'
        db.add_column('projects_projectinfo', 'classification_secondary',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secondary_classification', null=True, to=orm['projects.Classification']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectInfo.classification_secondary'
        db.delete_column('projects_projectinfo', 'classification_secondary_id')
