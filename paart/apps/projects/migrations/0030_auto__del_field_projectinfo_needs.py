...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectInfo.needs'
        db.delete_column('projects_projectinfo', 'needs')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectInfo.needs'
        raise RuntimeError("Cannot reverse this migration. 'ProjectInfo.needs' and its values cannot be restored.")
