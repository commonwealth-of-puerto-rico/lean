...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectDetails.priority'
        db.add_column('projects_projectdetails', 'priority',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['projects.Priority']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectDetails.priority'
        db.delete_column('projects_projectdetails', 'priority_id')
