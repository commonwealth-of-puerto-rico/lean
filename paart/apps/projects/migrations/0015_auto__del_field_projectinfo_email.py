...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectInfo.email'
        db.delete_column('projects_projectinfo', 'email')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectInfo.email'
        raise RuntimeError("Cannot reverse this migration. 'ProjectInfo.email' and its values cannot be restored.")
