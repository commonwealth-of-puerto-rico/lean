...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectOpportunities.other_agencies'
        db.delete_column('projects_projectopportunities', 'other_agencies')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectOpportunities.other_agencies'
        raise RuntimeError("Cannot reverse this migration. 'ProjectOpportunities.other_agencies' and its values cannot be restored.")
