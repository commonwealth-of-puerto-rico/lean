...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectInfo.phone_number'
        db.delete_column('projects_projectinfo', 'phone_number')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ProjectInfo.phone_number'
        raise RuntimeError("Cannot reverse this migration. 'ProjectInfo.phone_number' and its values cannot be restored.")
