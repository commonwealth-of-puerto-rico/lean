...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectDetails.agency'
        db.add_column('projects_projectdetails', 'agency',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['agencies.Agency'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectDetails.agency'
        db.delete_column('projects_projectdetails', 'agency_id')
    ...
    models = {
        ...
        'projects.projectdetails': {
            ...
            'agency': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['agencies.Agency']", 'unique': 'True'}),
