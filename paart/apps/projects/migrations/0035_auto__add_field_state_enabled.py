...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.enabled'
        db.add_column('projects_state', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.enabled'
        db.delete_column('projects_state', 'enabled')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'datetime_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 2, 0, 0)'}),
