...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_department', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('projects', ['Department'])

        # Deleting field 'ProjectInfo.department'
        db.delete_column('projects_projectinfo', 'department')


    def backwards(self, orm):
        # Deleting model 'Department'
        db.delete_table('projects_department')


        # User chose to not deal with backwards NULL issues for 'ProjectInfo.department'
        raise RuntimeError("Cannot reverse this migration. 'ProjectInfo.department' and its values cannot be restored.")
