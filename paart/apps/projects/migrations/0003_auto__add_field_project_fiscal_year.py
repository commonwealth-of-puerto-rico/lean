...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.fiscal_year'
        db.add_column('projects_project', 'fiscal_year',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='fiscal_year', to=orm['projects.FiscalYear']),
                      keep_default=False)
