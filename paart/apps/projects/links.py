...
from .icons import (icon_projects, icon_project_edit, icon_project_delete,
    icon_project_view, icon_agency_projects, icon_project_create_wizard)
...
link_project_view = Link(text=_(u'details'), view='project_view', args='resolved_object.pk', icon=icon_project_view, permissions=[PERMISSION_PROJECT_VIEW])
