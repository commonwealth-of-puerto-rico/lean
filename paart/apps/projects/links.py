...
link_project_view = Link(text=_(u'view'), view='project_view', args='resolved_object.pk', icon=icon_project_view, permissions=[PERMISSION_AGENCY_VIEW])
link_project_view_basic = Link(text=_(u'basic'), view='project_view', args='resolved_object.pk', icon=icon_project_view, permissions=[PERMISSION_AGENCY_VIEW])
link_project_create = Link(text=_(u'add project'), view='project_create', args='resolved_object.pk', icon=icon_project_create, permissions=[PERMISSION_AGENCY_EDIT])
...
link_project_file_delete = Link(text=_(u'delete'), view='project_file_delete', args='resolved_object.pk', icon=icon_project_file_delete, permissions=[PERMISSION_AGENCY_VIEW])
link_project_file_download = Link(text=_(u'download'), view='project_file_download', args='resolved_object.pk', icon=icon_project_file_download, permissions=[PERMISSION_AGENCY_VIEW])
