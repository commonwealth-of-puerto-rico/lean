...
from .icons import icon_projects, icon_project_edit, icon_project_delete, icon_agency_projects
...
link_agency_project_list = Link(text=_(u'project'), view='agency_project_list', args='resolved_object.pk', icon=icon_agency_projects)
