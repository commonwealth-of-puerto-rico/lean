...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('telecomm_equipment', 'internet_provider_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['telecomm.Provider']))

        # Changing field 'Equipment.wifi_provider'
        db.alter_column('telecomm_equipment', 'wifi_provider_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['telecomm.Provider']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Equipment.internet_provider'
        raise RuntimeError("Cannot reverse this migration. 'Equipment.internet_provider' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Equipment.wifi_provider'
        raise RuntimeError("Cannot reverse this migration. 'Equipment.wifi_provider' and its values cannot be restored.")
    ...
    models = {
        ...
        'telecomm.equipment': {
            ...
            'wifi_costs': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
