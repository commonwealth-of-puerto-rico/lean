...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Circuit.cost'
        db.delete_column('telecomm_circuit', 'cost')

        # Adding field 'Circuit.unit_cost'
        db.add_column('telecomm_circuit', 'unit_cost',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Circuit.units'
        db.add_column('telecomm_circuit', 'units',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Circuit.contract_start_date'
        db.add_column('telecomm_circuit', 'contract_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Circuit.contract_end_date'
        db.add_column('telecomm_circuit', 'contract_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Circuit.cost'
        raise RuntimeError("Cannot reverse this migration. 'Circuit.cost' and its values cannot be restored.")
        # Deleting field 'Circuit.unit_cost'
        db.delete_column('telecomm_circuit', 'unit_cost')

        # Deleting field 'Circuit.units'
        db.delete_column('telecomm_circuit', 'units')

        # Deleting field 'Circuit.contract_start_date'
        db.delete_column('telecomm_circuit', 'contract_start_date')

        # Deleting field 'Circuit.contract_end_date'
        db.delete_column('telecomm_circuit', 'contract_end_date')
    ...
    models = {
        ...
        'telecomm.circuit': {
            ...
            'unit_cost': ('django.db.models.fields.PositiveIntegerField', [], {}),
