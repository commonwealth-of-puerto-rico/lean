...
class Circuit(models.Model):
    ...
    purpose = models.CharField(max_length=128, verbose_name=_(u'purpose'), help_text=_(u'HELP_TEXT_PURPOSE'))
    identifier = models.CharField(max_length=128, verbose_name=_(u'identifier'), help_text=_(u'HELP_TEXT_IDENTIFIER'), blank=True)
