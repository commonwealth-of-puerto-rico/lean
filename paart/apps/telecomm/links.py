...
from .icons import (icon_equipment_edit, icon_equipment_delete, icon_equipment_view,
    icon_agency_equipment)
...
link_equipment_view = Link(text=_(u'details'), view='equipment_view', args='resolved_object.pk', icon=icon_equipment_view, permissions=[PERMISSION_EQUIPMENT_VIEW])
