...
link_tools_profile_create = Link(text=_(u'add tool profile'), view='tools_profile_create', args='resolved_object.pk', icon=icon_tools_profile_create)#, permissions=[PERMISSION_TOOLS_PROFILE_EDIT])
