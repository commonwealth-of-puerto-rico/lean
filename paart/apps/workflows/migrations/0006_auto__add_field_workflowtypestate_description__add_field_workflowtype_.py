...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowTypeState.description'
        db.add_column('workflows_workflowtypestate', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'WorkflowType.description'
        db.add_column('workflows_workflowtype', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'WorkflowTypeAction.description'
        db.add_column('workflows_workflowtypeaction', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowTypeState.description'
        db.delete_column('workflows_workflowtypestate', 'description')

        # Deleting field 'WorkflowType.description'
        db.delete_column('workflows_workflowtype', 'description')

        # Deleting field 'WorkflowTypeAction.description'
        db.delete_column('workflows_workflowtypeaction', 'description')
