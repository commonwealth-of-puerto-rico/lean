...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WorkflowTypeRelation', fields ['content_type', 'workflow_type']
        db.create_unique('workflows_workflowtyperelation', ['content_type_id', 'workflow_type_id'])

        # Adding unique constraint on 'WorkflowTypeState', fields ['label', 'workflow_type']
        db.create_unique('workflows_workflowtypestate', ['label', 'workflow_type_id'])

        # Adding unique constraint on 'WorkflowTypeAction', fields ['label', 'workflow_type']
        db.create_unique('workflows_workflowtypeaction', ['label', 'workflow_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WorkflowTypeAction', fields ['label', 'workflow_type']
        db.delete_unique('workflows_workflowtypeaction', ['label', 'workflow_type_id'])

        # Removing unique constraint on 'WorkflowTypeState', fields ['label', 'workflow_type']
        db.delete_unique('workflows_workflowtypestate', ['label', 'workflow_type_id'])

        # Removing unique constraint on 'WorkflowTypeRelation', fields ['content_type', 'workflow_type']
        db.delete_unique('workflows_workflowtyperelation', ['content_type_id', 'workflow_type_id'])
