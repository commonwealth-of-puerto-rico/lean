...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowInstanceHistory.user'
        db.add_column('workflows_workflowinstancehistory', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='user', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowInstanceHistory.user'
        db.delete_column('workflows_workflowinstancehistory', 'user_id')
