...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkflowType.initial_state'
        db.delete_column('workflows_workflowtype', 'initial_state_id')


        # Changing field 'WorkflowInstanceHistory.user'
        db.alter_column('workflows_workflowinstancehistory', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Adding field 'WorkflowType.initial_state'
        db.add_column('workflows_workflowtype', 'initial_state',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflows.WorkflowTypeState'], null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'WorkflowInstanceHistory.user'
        raise RuntimeError("Cannot reverse this migration. 'WorkflowInstanceHistory.user' and its values cannot be restored.")
    ...
    models = {
        ...
        'workflows.workflowinstancehistory': {
            'Meta': {'ordering': "['datetime_created']", 'object_name': 'WorkflowInstanceHistory'},
            'assignee_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Group']", 'null': 'True', 'blank': 'True'}),
            'assignee_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
        ...
        'workflows.workflowtypeaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'required_permission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['permissions.StoredPermission']", 'null': 'True', 'blank': 'True'}),
