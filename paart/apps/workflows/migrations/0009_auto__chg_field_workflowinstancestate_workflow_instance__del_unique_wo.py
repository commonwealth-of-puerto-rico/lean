...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'WorkflowInstanceState', fields ['workflow_instance']
        db.delete_unique('workflows_workflowinstancestate', ['workflow_instance_id'])


        # Changing field 'WorkflowInstanceState.workflow_instance'
        db.alter_column('workflows_workflowinstancestate', 'workflow_instance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflows.WorkflowInstance']))

    def backwards(self, orm):

        # Changing field 'WorkflowInstanceState.workflow_instance'
        db.alter_column('workflows_workflowinstancestate', 'workflow_instance_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['workflows.WorkflowInstance'], unique=True))
        # Adding unique constraint on 'WorkflowInstanceState', fields ['workflow_instance']
        db.create_unique('workflows_workflowinstancestate', ['workflow_instance_id'])
