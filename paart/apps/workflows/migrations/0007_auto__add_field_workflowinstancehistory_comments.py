...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowInstanceHistory.comments'
        db.add_column('workflows_workflowinstancehistory', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowInstanceHistory.comments'
        db.delete_column('workflows_workflowinstancehistory', 'comments')
