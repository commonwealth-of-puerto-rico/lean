...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowTypeAction.required_permission'
        db.add_column('workflows_workflowtypeaction', 'required_permission',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['permissions.StoredPermission'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowTypeAction.required_permission'
        db.delete_column('workflows_workflowtypeaction', 'required_permission_id')
