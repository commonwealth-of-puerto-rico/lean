...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkflowInstanceHistory.assignee_user'
        db.add_column('workflows_workflowinstancehistory', 'assignee_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkflowInstanceHistory.assignee_group'
        db.add_column('workflows_workflowinstancehistory', 'assignee_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkflowInstanceHistory.assignee_user'
        db.delete_column('workflows_workflowinstancehistory', 'assignee_user_id')

        # Deleting field 'WorkflowInstanceHistory.assignee_group'
        db.delete_column('workflows_workflowinstancehistory', 'assignee_group_id')
