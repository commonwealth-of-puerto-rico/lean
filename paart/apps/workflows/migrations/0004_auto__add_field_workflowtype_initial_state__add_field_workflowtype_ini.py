...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkflowType.initial_action'
        db.add_column('workflows_workflowtype', 'initial_action',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workflows.WorkflowTypeAction'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WorkflowType.initial_action'
        db.delete_column('workflows_workflowtype', 'initial_action_id')
    ...
    models = {
        ...
        'workflows.workflowtypeaction': {
            ...
            'connections': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'connections_rel_+'", 'blank': 'True', 'to': "orm['workflows.WorkflowTypeAction']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
